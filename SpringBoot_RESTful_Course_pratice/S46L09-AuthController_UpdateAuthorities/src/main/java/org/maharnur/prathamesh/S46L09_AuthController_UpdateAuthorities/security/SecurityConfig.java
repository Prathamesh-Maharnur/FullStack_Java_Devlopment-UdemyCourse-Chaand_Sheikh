package org.maharnur.prathamesh.S46L09_AuthController_UpdateAuthorities.security;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http.csrf(csrf -> csrf.ignoringRequestMatchers("/db-console/**"))
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/auth/users", "/auth/users/update-authorities/**").hasAuthority("SCOPE_ADMIN"))
