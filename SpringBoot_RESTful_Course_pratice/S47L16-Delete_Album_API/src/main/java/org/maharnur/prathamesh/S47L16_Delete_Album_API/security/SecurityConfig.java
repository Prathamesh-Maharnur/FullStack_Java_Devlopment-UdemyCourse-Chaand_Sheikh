package org.maharnur.prathamesh.S47L16_Delete_Album_API.security;
                ...
                http.csrf(csrf -> csrf.ignoringRequestMatchers("/db-console/**"))
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/api/v1/auth/profile",
                                                                ...
                                                                "/api/v1/albums/{album_id}/photos/{photo_id}/download-thumbnail",
                                                                "/api/v1/albums/{album_id}",
                                                                "/api/v1/albums/{album_id}/update",
                                                                "/api/v1/albums/{album_id}/photos/{photo_id}/update",
                                                                "/api/v1/albums/{album_id}/photos/{photo_id}/delete",
                                                                "/api/v1/albums/{album_id}/delete"
                                                        )
                                                .authenticated()
